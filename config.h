...
static const char *fonts[]          = {"JetBrains Mono Nerd Font:size=11:antialias=true", "fontawesome:size=12:antialias=true", "JoyPixels:size=11:antialias=true:autohint=true" };
...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, col_cyan,  "#6c1005" },
};
...
static Key keys[] = {
 ...
 // { XF86XK_AudioMute,            spawn,           SHCMD ("pamixer --allow-boost -t;  kill -44 $(pidof dwmblocks)") },
